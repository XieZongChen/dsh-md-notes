...
4. Send → each chip serializes to a readable line, e.g.
   `Referenced note "title": <absolute note path>`; the model reads the
   referenced note and answers with it. A plain-text
